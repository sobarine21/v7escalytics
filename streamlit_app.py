...
scenario_options = [
    ...
    "Customer Service Wait Time Issue",
    "Online Order Discrepancy",
    "Promotional Offer Inquiry",
    "Referral Program Inquiry",
    "Service Cancellation",
    "Fraud Investigation Request",
    "Payment Refund Follow-up",
    "Product Compatibility Inquiry",
    "Sales Order Clarification",
    "Order Packaging Issue",
    ...
    "Change of Service Provider Inquiry",
    "Virtual Product Trial Inquiry",
    "Customer Account Privacy Update",
    "Product Demo Request",
    "Out-of-Stock Notification Request",
    "Bulk Order Inquiry",
    "Shipping Cost Inquiry",
    "Product Specification Inquiry",
    "Return Shipping Process Inquiry",
    ...
    "Data Export Request",
    "Missing Invoice Issue",
    "Manual or Guide Request",
    ...
    "Hardware Issue",
    "Payment Gateway Downtime Issue",
    "Account Security Lock",
    "E-commerce Shopping Cart Issue",
    "Integration with Other Tools Request",
    "Shipping Insurance Inquiry",
    "Product Upgrade Availability",
    "App Login Issue",
    "Refund Method Preference Inquiry",
    "Order Cancellation Due to Fraud",
    "Email Newsletter Inquiry",
    "Legal Compliance Inquiry",
    "E-commerce Store Customization Request",
    "Service Refund Request",
    "Security Breach Report",
    "Customer Data Request",
    "Marketing Promotion Inquiry",
    "Product Expiration Date Inquiry",
    "Service Feedback",
    "Technical Support Response Inquiry",
    "Service Activation Request",
    "Product Trial Extension Request",
    "Business Account Inquiry",
    "Payment Method Update Request",
    "Shipping Insurance Claim",
    "Expired Promotion Claim",
    "Customer Referral Reward Inquiry",
    "Product Testing or Review Request",
    "Mobile App Feature Suggestion",
    "Social Media Inquiry",
    "Order Packing Error Report",
    "Loyalty Program Benefits Inquiry",
    "Delayed Delivery Compensation Request",
    "Inventory Availability Inquiry",
    "Service Quality Complaint",
    "Custom Order Processing Request",
    "Website Performance Issue",
    "Customer Account Deletion Request",
    "Refund for Damaged Product Request",
